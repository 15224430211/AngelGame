            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action="/tweet" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <textarea name="content" style="margin-bottom: 5px;" class="form-control" rows="1"
                                          maxlength="140" placeholder="请输入要分享的内容,最大长度140字"></textarea>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="media">
                                <a class="pull-left" href="#">
                                    <img src="/assets/images/UserPic/small/{{$tweet->avatar}}" class="media-object"
                                         data-src="holder.js/64x64" alt="64x64">
                                </a>

                                <div class="media-body">
                                    <h4 class="media-heading"><a href="#">{{$tweet->username}}({{substr($tweet->updated_at,0,10)}})</a>
                                    </h4>

                                    <p>{{$tweet->content}}</p>

                                    <p>
                                        <a mid="{{$tweet->mid}}" href="javascript:void(0)"
                                           class="label label-info show-comment">回复(<span>{{$tweet->replies}}</span>)</a>
                                        <a mid="{{$tweet->mid}}" href="javascript:void(0)"
                                           class="label label-info retweet"><span
                                                class="glyphicon glyphicon-remove"></span> 转播</a>
                                    </p>
                                </div>
                            </div>
                            <hr class="hr-margin-10">
