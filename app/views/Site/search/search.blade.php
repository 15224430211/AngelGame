                    ...
                    <div class="row game-list">
                        <div class="col-md-2">
                            <a href="/game/{{$game_info->game_uid}}" class="thumbnail">
                                <img src="/assets/images/GamePic/{{$game_info->game_pic}}" data-src="holder.js/100%x180"
                                     alt="...">
                            </a>
                        </div>
                        <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <span class="play-status-buttons">
                                        ...
                                        <button game-uid="{{$game_info->game_uid}}" data-toggle="modal"
                                        ...
                                        <button game-uid="{{$game_info->game_uid}}" data-toggle="modal"
                                                data-target="#status-modal" class="btn btn-info btn-sm play-want"
                                                disabled>我想玩这个游戏
                                        </button>
                                        <button game-uid="{{$game_info->game_uid}}" data-toggle="modal"
                                                data-target="#status-modal" class="btn btn-primary btn-sm playing">我正在玩
                                        ...
                                        <button game-uid="{{$game_info->game_uid}}" data-toggle="modal"
                                                data-target="#status-modal" class="btn btn-primary btn-sm playing"
                                                disabled>我正在玩这个游戏
                                        </button>
                                        <button game-uid="{{$game_info->game_uid}}" data-toggle="modal"
                                                data-target="#status-modal" class="btn btn-success btn-sm played">我玩过
                                        ...
                                        <button game-uid="{{$game_info->game_uid}}" data-toggle="modal"
                                                data-target="#status-modal" class="btn btn-success btn-sm played">
                                            我玩过这个游戏
                                        </button>
                                        @endif
                                    </span>
